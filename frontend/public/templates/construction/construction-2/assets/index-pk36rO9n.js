 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mx=t=>{for(const e in t)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1},gx=_e.createContext({}),vx=()=>_e.useContext(gx),_x=_e.forwardRef(({color:t,size:e,strokeWidth:n,absoluteStrokeWidth:i,className:r="",children:s,iconNode:o,...a},l)=>{const{size:c=24,strokeWidth:d=2,absoluteStrokeWidth:h=!1,color:f="currentColor",className:m=""}=vx()??{},_=i??h?Number(n??d)*24/Number(e??c):n??d;return _e.createElement("svg",{ref:l,...sc,width:e??c??sc.width,height:e??c??sc.height,stroke:t??f,strokeWidth:_,className:Zg("lucide",m,r),...!s&&!mx(a)&&{"aria-hidden":"true"},...a},[...o.map(([x,p])=>_e.createElement(x,p)),...Array.isArray(s)?s:[s]])});/**
 * @license lucide-react v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
