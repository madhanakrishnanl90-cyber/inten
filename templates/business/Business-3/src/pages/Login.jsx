  ...
  return (
    <AnimatedPage>
      <div className="pt-24 pb-20 min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute top-[-20%] left-[-20%] w-[50%] h-[50%] bg-[#7C3AED]/20 rounded-full blur-[100px] -z-10" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#4C1D95]/30 rounded-full blur-[100px] -z-10" />

        <div className="w-full max-w-md px-6">
          <div className="bg-lightAccent border border-customBorder rounded-3xl p-8 shadow-lg flex flex-col gap-6">
            ...
            {error && (
              <div className="bg-rose-950/20 border border-rose-900/50 text-rose-300 px-4 py-3 rounded-xl text-xs flex items-center gap-2.5">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 text-secondaryText" size={16} />
                  <input
                    type="text"
                    value={username}
                    onChange={(e) => setUsername(e.target.value)}
                    className="w-full bg-[#1E1033] border border-customBorder rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText placeholder-secondaryText/40 transition-all"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-secondaryText" size={16} />
                  <input
                    type="password"
                    value={password}
