      ...
      <div className="pt-24 pb-20 overflow-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-md border border-customBorder bg-[#1E1033]">
              <img 
            ...
            <div className="flex flex-col gap-4">
              ...
              <span className="text-sm font-bold text-primaryAccent bg-[#2E1A47] px-3.5 py-1 rounded-full w-fit uppercase tracking-wider">
                {project.category}
              </span>
            </div>

            <div className="prose prose-slate max-w-none text-secondaryText text-sm sm:text-base leading-relaxed border-t border-customBorder pt-6">
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel border border-customBorder rounded-3xl p-6.5 shadow-sm flex flex-col gap-6 sticky top-28">
              <h2 className="text-lg font-bold text-primaryText uppercase tracking-wider border-b border-customBorder pb-3">Project Specs</h2>
              ...
              <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {project.techStack.split(',').map((tech) => (
                        <span key={tech} className="text-xs font-mono bg-[#1E1033] text-[#C4B5FD] px-3 py-1 rounded-md border border-customBorder">
                          {tech.trim()}
                        </span>
                      ))}
                    </div>
                ...
                {project.projectUrl && (
                  <div className="pt-4 border-t border-customBorder">
                    <a 
