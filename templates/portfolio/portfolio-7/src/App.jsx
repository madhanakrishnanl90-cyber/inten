...
function ScrollToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed bottom-6 right-6 z-40 w-10 h-10 rounded-full bg-[#ff5722] hover:bg-[#e64a19] text-white flex items-center justify-center shadow-lg transition-colors border border-white/5 cursor-pointer focus:outline-none"
    >
      <ArrowUp size={16} />
    </button>
  );
...
function SectionHeading({ eyebrow, title }) {
  return (
    <div className="mb-16 text-left">
      <span className="text-[10px] font-sans tracking-[0.25em] text-[#ff5722] uppercase font-black block mb-3">
        {eyebrow}
      </span>
  ...
  return (
    <div className="min-h-screen bg-[#141414] text-white flex flex-col selection:bg-[#ff5722] selection:text-white">
      ...
      <section id="home" className="hero-orange-red-gradient relative min-h-[95vh] flex flex-col justify-between pt-32 pb-16 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center my-auto">
          ...
          <div className="lg:col-span-8 flex flex-col items-start text-left">
            <span className="text-xs font-sans tracking-[0.3em] text-white/80 uppercase font-bold mb-3 block">
              {gradientData.hero.greeting}
            </span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tight leading-[0.9] uppercase select-none">
            ...
            <div className="mt-10 flex flex-col md:flex-row gap-8 items-start md:items-center max-w-2xl font-sans">
              ...
              <div>
                <h3 className="text-xl text-white font-bold leading-normal uppercase">{gradientData.hero.tagline}</h3>
                <p className="text-xs text-white/70 leading-relaxed mt-2 text-justify font-sans">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 font-sans">
            {gradientData.hero.expertiseTags.map((tag, idx) => (
              <div key={idx} className="flex flex-col items-start">
                <span className="text-[10px] font-sans font-black text-white/50 block mb-1">{tag.num}</span>
                <span className="text-xs md:text-sm text-white font-extrabold uppercase tracking-wide">{tag.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 md:px-12 relative z-25 -mt-8 font-sans">
        <div className="max-w-7xl mx-auto bg-[#1a1a1a] border border-zinc-900 rounded-2xl p-8 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          
          <div className="lg:col-span-4 text-left">
            <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block mb-1">CREDIBILITY</span>
            <h4 className="text-xs text-white font-black uppercase tracking-wider">
              {gradientData.logoStrip.label}
            </h4>
          </div>

          <div className="lg:col-span-8 flex flex-wrap items-center justify-start lg:justify-end gap-8 opacity-45">
            {gradientData.logoStrip.logos.map((logo, idx) => (
              <div key={idx} className="flex items-center gap-2 filter grayscale">
                ...
                <span className="text-[10px] font-bold text-zinc-400 tracking-widest uppercase">{logo.name}</span>
              </div>
            ))}
          </div>
      ...
      <section id="about" className="py-32 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-start justify-center h-full">
            <div className="border border-zinc-900 p-8 w-full bg-[#1c1c1c] text-left relative flex flex-col gap-6">
              ...
              <button
                ...
                className="px-6 py-3 rounded-full bg-[#ff5722] hover:bg-[#e64a19] text-white font-bold text-xs tracking-wider uppercase transition-colors flex items-center justify-center gap-2 cursor-pointer border-none focus:outline-none w-fit"
              >
        ...
        <div className="flex flex-wrap gap-2 mb-12 pb-4 border-b border-zinc-900 font-sans">
          {projectFilters.map((filter, idx) => (
            <button
              ...
              className={`px-5 py-2 text-[10px] font-sans tracking-widest uppercase font-black transition-all cursor-pointer ${
            ...
            >
              ...
              <div className="flex justify-between items-baseline px-1 font-sans">
                <div className="text-left font-sans">
                  <h4 className="text-lg text-white font-bold group-hover:text-[#ff5722] transition-colors uppercase leading-none">
                    {project.title}
                  </h4>
                  <span className="text-[10px] font-sans tracking-widest text-[#ff5722] uppercase font-bold mt-1.5 block">
                    {project.category}
                  </span>
                </div>
      ...
      {/* CONTACT SECTION */}
      <section id="contact" className="py-32 px-6 md:px-12 bg-[#0c0c0c] border-t border-zinc-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-none uppercase mb-6">
            {gradientData.contact.heading}
          </h2>
          <p className="text-sm text-zinc-500 font-sans max-w-md mx-auto leading-relaxed mb-12">
          ...
          <form onSubmit={handleFormSubmit} className="max-w-xl mx-auto flex flex-col gap-6 text-left font-sans">
            ...
            <button
              ...
              className="mt-6 w-full py-4 bg-[#ff5722] hover:bg-[#e64a19] disabled:bg-zinc-800 text-white font-extrabold text-xs tracking-wider uppercase flex items-center justify-center gap-2 transition-colors cursor-pointer border-none"
            >
              {formStatus === 'loading' ? (
          ...
          <div className="text-[8px] tracking-widest text-zinc-700 uppercase font-bold mt-12 font-sans">
          ...
          >
            ...
            >
              ...
              <div className="col-span-12 md:col-span-5 p-8 flex flex-col justify-between">
                ...
                <div className="mt-12 pt-6 border-t border-zinc-800 flex flex-col gap-4 font-sans">
