...
export default function FooterPhotography() {
  return (
    <footer className="bg-[#090909] border-t border-zinc-950 text-zinc-500 py-16 px-6 md:px-12 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 relative z-10">
        ...
        <div className="col-span-12 md:col-span-4 flex flex-col items-start">
          <Link to="/templates/portfolio/photography-portfolio" className="font-serif-heading text-lg font-black text-white uppercase tracking-wider mb-4">
          ...
          <div className="flex gap-4">
            {photographyData.socials.map((soc, idx) => (
              <a
                ...
                className="w-8 h-8 rounded-full border border-zinc-900 bg-zinc-955 text-zinc-500 hover:text-white flex items-center justify-center transition-all text-xs"
              >
