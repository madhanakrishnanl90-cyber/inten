...
export default function NavBarCreativeMultipage() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-zinc-100 py-4 px-6 md:px-12 font-sans shadow-xs">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Logo */}
        <Link to="/templates/portfolio/creative-multipage-portfolio" className="font-serif-heading text-xl md:text-2xl font-black text-zinc-900 hover:text-zinc-650 transition-colors uppercase tracking-wider">
          ...
          {creativeData.navigation.map((item, idx) => {
            ...
            return (
              <NavLink
                key={idx}
                to={item.path}
                end={item.path === "/templates/portfolio/creative-multipage-portfolio"}
                className={({ isActive }) => 
