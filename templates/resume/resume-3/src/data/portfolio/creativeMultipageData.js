export const creativeData = {
  ...
  navigation: [
    { label: "Home", path: "/templates/portfolio/creative-multipage-portfolio" },
    { label: "About", path: "/templates/portfolio/creative-multipage-portfolio/about" },
    { label: "Services", path: "/templates/portfolio/creative-multipage-portfolio/services" },
    { label: "Portfolio", path: "/templates/portfolio/creative-multipage-portfolio/portfolio" },
    { label: "Team", path: "/templates/portfolio/creative-multipage-portfolio/team" },
    {
      label: "Info",
      submenu: [
        { label: "Pricing", path: "/templates/portfolio/creative-multipage-portfolio/pricing" },
        { label: "Testimonials", path: "/templates/portfolio/creative-multipage-portfolio/testimonials" }
      ]
    },
    { label: "Contact", path: "/templates/portfolio/creative-multipage-portfolio/contact" }
  ],
