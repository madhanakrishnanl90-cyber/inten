...
export default function NavBarMinimal() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-40 bg-[#fafafc]/85 backdrop-blur-md border-b border-zinc-150 py-5 px-6 md:px-12 transition-all font-sans">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 bg-[#fafafc] flex flex-col justify-between p-8 md:p-16 font-sans"
          >
            {/* Header in Overlay */}
