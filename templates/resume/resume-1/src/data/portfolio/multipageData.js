export const portfolioData = {
  ...
  navigation: [
    { label: "Home", path: "/templates/portfolio/multipage-portfolio" },
    { label: "About", path: "/templates/portfolio/multipage-portfolio/about" },
    { label: "Resume", path: "/templates/portfolio/multipage-portfolio/resume" },
    { label: "Services", path: "/templates/portfolio/multipage-portfolio/services" },
    { label: "Portfolio", path: "/templates/portfolio/multipage-portfolio/portfolio" },
    { 
      label: "Submenu", 
      path: "#",
      dropdown: [
        { label: "Pricing Plan", path: "/templates/portfolio/multipage-portfolio/pricing" },
        { label: "Creative Team", path: "/templates/portfolio/multipage-portfolio/team" }
      ]
    },
    { label: "Contact", path: "/templates/portfolio/multipage-portfolio/contact" }
  ],
