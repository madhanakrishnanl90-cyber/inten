export const agencyData = {
  ...
  navigation: [
    { label: "Home", path: "/templates/portfolio/agency-portfolio" },
    { label: "Services", path: "/templates/portfolio/agency-portfolio/services" },
    { label: "About", path: "/templates/portfolio/agency-portfolio/about" },
    { label: "News", path: "/templates/portfolio/agency-portfolio/news" },
    { label: "Contact", path: "/templates/portfolio/agency-portfolio/contact" }
  ],
