...
import { portfolioData } from '../../data/portfolio/creativeData';
...
export default function NavBarCreative() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#f5f5fb]/95 backdrop-blur-sm border-b border-zinc-200/60 font-sans">
