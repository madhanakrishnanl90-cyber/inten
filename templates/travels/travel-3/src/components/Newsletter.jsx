    ...
    <section id="blog" className="py-16 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <motion.div
          ...
          className="bg-gradient-to-r from-primary to-primary-dark rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden shadow-xl"
        >
          {/* Decorative floating dots/paths */}
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            <span className="font-sans font-bold text-xs tracking-widest text-accent uppercase">
              Subscribe Now
            </span>
            ...
            <p className="font-sans text-slate-100/80 text-sm md:text-base leading-relaxed max-w-lg mx-auto">
                ...
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      type="submit"
                      className="bg-white text-primary hover:bg-slate-50 font-sans font-extrabold text-xs px-6 py-3.5 rounded-xl tracking-widest uppercase flex items-center justify-center gap-2 cursor-pointer shadow-md"
                    >
                      <span>Subscribe</span>
