...
export const WealthPage: React.FC = () => {
  const service = SERVICES.find(s => s.id === 'wealth-management') || SERVICES[3];
      ...
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        <div className="space-y-6 max-w-4xl">
          ...
          <span className="text-[11px] uppercase tracking-[0.25em] text-[#191919]/50 font-medium block">
            FAMILY OFFICE & PRIVATE CLIENT FIDUCIARY
          </span>
          ...
          <div className="pt-4 flex flex-wrap gap-4 items-center">
            ...
            >
              <span>Schedule Family Office Review</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </Link>
            <div className="text-xs font-mono text-[#191919]/50">
              Intergenerational Stewardship • Tax & Cross-Border Estate
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pt-12 border-t border-[#E5E5E5]">
          <div className="md:col-span-4 space-y-2">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl text-[#191919] font-normal">
              Preservation & multi-generational planning
            </h2>
          </div>
