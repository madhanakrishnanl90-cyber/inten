...
import { Globe, SunMedium, Sparkles } from 'lucide-react';
...
export function AnnouncementBar() {
  ...
  return (
    <div className="hidden sm:block border-b border-[#E8E5DC] bg-[#FAF9F5] text-[#52524E] text-[0.75rem] py-1.5 px-4 md:px-8 transition-colors">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        {/* Left: Date & Global Bureaus */}
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-1.5 text-[#52524E]">
        ...
        {/* Right: Edition Switcher & Subscription Dispatch */}
        <div className="flex items-center gap-4">
